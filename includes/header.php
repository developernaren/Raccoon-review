    ...
    <script>
        $(document).ready(function()
        {
            $(".header-menu a").click(function(){
                ...
                $.ajax({url: "http://localhost/Raccoon-review/", success: function(result){
            ...
            $(".rac-container .rac-info #nameSort #asc").click(function(){
                ...
                $.ajax({url: "http://localhost/Raccoon-review/api/raccoon/sortByAsc", success: function(result){
            ...
            $(".rac-container .rac-info #nameSort #desc").click(function(){
                ...
                $.ajax({url: "http://localhost/Raccoon-review/api/raccoon/getBySortByDesc", success: function(result){
